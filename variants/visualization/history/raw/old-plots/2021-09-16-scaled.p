...
set output '2021-09-16-all-weeks-scaled.png'
set title "Selected NYC Covid Variant counts from Jan 2 to Sep 4 \n Pandemic Response Lab Sequencing, Updated Sep 16 \n chart by Mr. Mosher" font "arial,33"
...
set mytics 
plot '../../../history/2021-09-16-readable.csv' \
using 23 t "Total cases" w impulse lc  rgb "#00CC00" lw 5, \
...
'' using 18 t "B.1.621 (Mu)" lc rgb "#9B581C", \
'' using 20 t "Other" lc rgb "#888888"
...
# "incomplete":22
# "cases": 23
# "percent sequenced": 24
# "incomplete sequencing": 25
